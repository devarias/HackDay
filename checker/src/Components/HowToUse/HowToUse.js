...
function HowToUse(props) {
  ...
  const onclick = () => {props.history.push("/login")};
      ...
      <div>
        <div className="title">How to use</div>
          <ol>
              ...
              <li>Type down the number of the project that you want to check and click on the submit button.</li>
              <li>Click in the show button to display all the tasks from the project.</li>
